...
WebUI.rightClick(findTestObject('Object Repository/Page_Swag Labs/div_Accepted usernames arestandard_userlock_0ab16f'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_user-name'))

WebUI.rightClick(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_user-name'))
